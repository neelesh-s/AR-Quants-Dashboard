                ...
                <div className="div-one mt-8 md:mx-4 lg:mx-10 flex flex-col w-full ">
                    ...
                    <div className='div-two md:mt-10 mt-4 md:mx-10 '>
                        <div className='md:mx-8 p-4 flex flex-col '>
                            ...
                            <p className='text-gray-600 font-poppins text-sm font-normal leading-normal py-2 md:block hidden' >Formulate a strategy that suits your trading style. Personalize your entry signals, choose indicators, and configure risk management parameters.
                            ...
                            <div className='inline-flex flex-row justify-evenly w-full mt-4'>
                                ...
                                <div className='rounded-md border-yellow-500 border bg-white w-auto '>
                                    <select name="none" id="none" className='px-10 border-yellow-900'>
                                        <option selected className='text-white text-base font-normal'>
                                        </option>
                                    </select>
                                </div>
                                <div className='border rounded-md w-auto bg-white '>
                                    <select name="empty" id="empty" className=' px-16 border-yellow-900'>
                                        <option selected className='text-white text-base font-normal '>
                                        </option>
                                    </select>
                                ...
                                <div className='rounded-md flex border bg-white border-solid border-yellow-500  items-center justify-center '>
                                    <input type="text" className='text-sm font-thin ' placeholder='enter value'/>
                                </div>
                                <div className='text-blue-600'
                                ><DeleteOutlineTwoTone />
